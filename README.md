...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-Java-Dropwizard/releases/download/1.12.7/release.tar.gz
tar -xvzf release.tar.gz
cd release
java -jar annotation-1.12.7.jar configuration.yaml
## Open http://localhost:8080/annotation/ in your favorite browser.
```
